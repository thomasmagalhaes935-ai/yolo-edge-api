...
def predict_image(request: PredictRequest):
    """Executa inferência em imagem enviada e retorna JPEG com caixas."""
    _metrics["total"] += 1
...
def predict_from_camera(
    ...
    """Captura foto pela câmera, infere e retorna detecções em JSON."""
    _metrics["total"] += 1
...
def predict_from_camera_image(
    ...
    """Captura câmera, infere e renderiza bounding boxes."""
    _metrics["total"] += 1
...
async def stream_camera(
    ...
    """Transmite vídeo contínuo com detecções YOLO sobrepostas."""
    ...
    async def frame_generator():
        ...
        print(
            f"[stream/camera] rpicam-vid iniciado "
            f"(pid={proc.pid})",
            flush=True,
        )
            ...
            try:
                ...
                while True:
                    ...
                    try:
                        ...
                        print(
                            "[stream/camera] Nenhum frame em 5s "
                            "— encerrando.",
                            flush=True,
                        )
                        break
                ...
                if proc.stderr:
                    ...
                    if stderr_output:
                        print(
                            "[stream/camera] rpicam-vid stderr:\n"
                            f"{stderr_output}",
                            flush=True,
                        )
...
async def stream_view():
    """Página simples para visualizar o stream anotado."""
    return """
    <!DOCTYPE html>
    <html>
    <head>
